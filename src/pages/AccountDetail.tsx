      ...
      <div className="px-4 py-6 flex flex-col flex-1">
        ...
        <div>
          ...
          {config.moveFundsButton && (
            <button onClick={handleMoveFunds} className="w-full py-3  rounded-lg mb-4 font-semibold text-black text-base flex items-center justify-center gap-2" style={{ backgroundColor: account.color }}>
